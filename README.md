# ![LOGO](logo.png) AWS SecurityHub **flow**ground Connector

## Description

A generated **flow**ground connector for the AWS SecurityHub API (version 2018-10-26).
...
**flow**ground :- Telekom iPaaS / amazonaws-com-securityhub-connector<br/>
